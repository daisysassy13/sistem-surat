...
<div class="page-header">
    <h1 class="page-title"><i class="bi bi-send-fill"></i> Tambah Surat Keluar</h1>
</div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light" value="{{ $nomorSurat }}" readonly>
                        <small class="text-muted">Nomor surat dibuat otomatis</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tujuan_surat" class="form-control @error('tujuan_surat') is-invalid @enderror" 
                               value="{{ old('tujuan_surat') }}" placeholder="Contoh: Kecamatan, Dinas, Warga" required>
                        @error('tujuan_surat')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label">File Surat (PDF, Max 5MB) <span class="text-danger">*</span></label>
